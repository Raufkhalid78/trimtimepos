...
const Inventory: React.FC<InventoryProps> = ({ 
  ...
  return (
    <div className="space-y-4 md:space-y-6">
      ...
      <div className="flex bg-white dark:bg-slate-900 p-1 rounded-xl shadow-sm border border-slate-100 dark:border-slate-800 self-start w-full sm:w-auto overflow-x-auto scrollbar-hide">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {activeTab === 'logs' ? (
            stockLogs.map((log) => {
                ...
                return (
                    <div key={log.id} className="bg-white dark:bg-slate-900 p-4 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm">
            ...
            filteredSuppliers.map((supplier) => (
                <div key={supplier.id} className="bg-white dark:bg-slate-900 p-5 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-md transition-all">
            ...
            items.map((item: any) => (
           <div key={item.id} className="bg-white dark:bg-slate-900 p-5 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-md transition-all">
              <div className="flex justify-between items-start mb-2">
                 <div>
        ...
        {showDeleteConfirm && (
          ...
          >
            <motion.div
              ...
              className="bg-white dark:bg-slate-900 rounded-2xl shadow-xl max-w-md w-full p-6 border border-slate-100 dark:border-slate-800"
            >
